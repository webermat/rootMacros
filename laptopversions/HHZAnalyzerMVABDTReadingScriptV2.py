...
def process_event(i_final_histo_name_,i_input_file_name_,i_weight_file,i_weight_file2,i_isSignalData):

    reader = root.TMVA.Reader("V:Color:!Silent")
    reader2 = root.TMVA.Reader("V:Color:!Silent")
    ...
    reader2.AddVariable("comb_jet1_mass", v_comb_jet1_mass)
    reader2.AddVariable("comb_jet2_mass", v_comb_jet2_mass)
    reader2.AddVariable("comb_jet3_mass", v_comb_jet3_mass)
    reader2.AddVariable("comb_jet1_dalpha", v_comb_jet1_dalpha)
    reader2.AddVariable("comb_jet2_dalpha", v_comb_jet2_dalpha)
    reader2.AddSpectator("comb_jet3_dalpha", v_comb_jet3_dalpha)
    reader2.AddSpectator("comb_jet1_E1_over_Etot", v_comb_jet1_E1_over_Etot)
    reader2.AddSpectator("comb_jet2_E1_over_Etot", v_comb_jet2_E1_over_Etot)
    reader2.AddSpectator("comb_jet3_E1_over_Etot", v_comb_jet3_E1_over_Etot)
    reader2.AddVariable("comb_jet1_BTagMax", v_comb_jet1_BTagMax)
    reader2.AddVariable("comb_jet2_BTagMax", v_comb_jet2_BTagMax)
    reader2.AddVariable("comb_jet3_BTagMax", v_comb_jet3_BTagMax)
    reader2.AddSpectator("comb_jet1_cosThetaHel_absmin", v_comb_jet1_cosThetaHel_absmin)
    reader2.AddSpectator("comb_jet2_cosThetaHel_absmin", v_comb_jet2_cosThetaHel_absmin)
    reader2.AddSpectator("comb_jet3_cosThetaHel_absmin", v_comb_jet3_cosThetaHel_absmin)
    reader2.AddSpectator("comb_jet1_E", v_comb_jet1_E)
    reader2.AddSpectator("comb_jet2_E", v_comb_jet2_E)
    reader2.AddSpectator("comb_jet3_E", v_comb_jet3_E)
    reader2.AddSpectator("comb_jet1_theta", v_comb_jet1_theta)
    reader2.AddSpectator("comb_jet2_theta", v_comb_jet2_theta)
    reader2.AddSpectator("comb_jet3_theta", v_comb_jet3_theta)
    reader2.AddVariable("BTag_sum_max2", v_BTag_sum_max2)
    reader2.AddVariable("BTag_sum_max3", v_BTag_sum_max3)
    reader2.AddSpectator("BTag_sum_max4", v_BTag_sum_max4)
    reader2.AddSpectator("BTag_sum_all", v_BTag_sum_all)
    reader2.AddSpectator("CTag_sum_max2", v_CTag_sum_max2)
    reader2.AddSpectator("CTag_sum_max3", v_CTag_sum_max3)
    reader2.AddVariable("LTag_sum_all", v_LTag_sum_all)
    reader2.AddVariable("comb_jet1_CTagMax", v_comb_jet1_CTagMax)
    reader2.AddVariable("comb_jet2_CTagMax", v_comb_jet2_CTagMax)
    reader2.AddSpectator("comb_jet3_CTagMax", v_comb_jet3_CTagMax)
    reader2.AddVariable("comb_jet1_LTagMax", v_comb_jet1_LTagMax)
    reader2.AddVariable("comb_jet2_LTagMax", v_comb_jet2_LTagMax)
    reader2.AddVariable("comb_jet3_LTagMax", v_comb_jet3_LTagMax)
    reader2.AddSpectator("comb_jet1_LTagMin", v_comb_jet1_LTagMin)
    reader2.AddSpectator("comb_jet2_LTagMin", v_comb_jet2_LTagMin)
    reader2.AddSpectator("comb_jet3_LTagMin", v_comb_jet3_LTagMin)
    reader2.AddVariable("jet1_theta", v_jet1_theta)
    reader2.AddVariable("jet2_theta", v_jet2_theta)
    reader2.AddVariable("jet3_theta", v_jet3_theta)
    reader2.AddVariable("jet4_theta", v_jet4_theta)
    reader2.AddVariable("jet5_theta", v_jet5_theta)
    reader2.AddVariable("jet6_theta", v_jet6_theta)
    reader2.AddVariable("jet1_E", v_jet1_E)
    reader2.AddVariable("jet2_E", v_jet2_E)
    reader2.AddVariable("jet3_E", v_jet3_E)
    reader2.AddVariable("jet4_E", v_jet4_E)
    reader2.AddVariable("jet5_E", v_jet5_E)
    reader2.AddVariable("jet6_E", v_jet6_E)
    reader2.AddSpectator("jet1_BTag", v_jet1_BTag)
    reader2.AddSpectator("jet2_BTag", v_jet2_BTag)
    reader2.AddSpectator("jet3_BTag", v_jet3_BTag)
    reader2.AddSpectator("jet4_BTag", v_jet4_BTag)
    reader2.AddSpectator("jet5_BTag", v_jet5_BTag)
    reader2.AddSpectator("jet6_BTag", v_jet6_BTag)
    reader2.AddVariable("y12", v_y12)
    reader2.AddVariable("y23", v_y23)
    reader2.AddVariable("y34", v_y34)
    reader2.AddVariable("y45", v_y45)
    reader2.AddVariable("y56", v_y56)
    ...
    reader2.BookMVA('BDT',TString(i_weight_file2))  
    ...
    for bdt_value in BDT_cuts:
        for bdt_value2 in BDT_cuts:
            tdirectory=fileout.GetDirectory(i_final_histo_name_)
            fileout.mkdir(str(bdt_value)+"/"+str(bdt_value2))
            fileout.cd(str(bdt_value)+"/"+str(bdt_value2))
            ...
            h_BDT_output2 = TH1F( "h_BDT_output2", "", n_bins_high, lim_BDT_low, lim_BDT_high)
            h_BDT_output2_Eff = TH1F( "h_BDT_output2_Eff", "", n_bins_high, lim_BDT_low, lim_BDT_high)
        ...
        #BDTCut=0.50
            total_weight=0
            if((bdt_value>0.59 or bdt_value2>0.59) or (bdt_value<0.25 and bdt_value2<0.25)):
                continue;
            ...
            #print "sig BG in entry ",num_entry,bdt_value             
                ...
                mvaValue2=reader.EvaluateMVA("BDT")
                if num_entry%(int(tree.GetEntries()/5.)) == 0:
                    print "sig BG in entry/bdt-folder/mva/tot_weight ",num_entry,bdt_value,bdt_value2,mvaValue,mvaValue2,total_weight
            #we only get here, if we pass reco style cuts
                h_BDT_output.Fill(mvaValue,v_weight[0])
                h_BDT_output2.Fill(mvaValue2,v_weight[0])
                if(mvaValue>bdt_value and mvaValue>bdt_value2):
                    total_weight+=v_weight[0]
                #print 'parton stuff',v_sqrtS_parton[0]
                    h_BDT_output_Eff.Fill(mvaValue,v_weight[0])
                    h_BDT_output2_Eff.Fill(mvaValue2,v_weight[0])
                    if i_isSignalData:
        ...
        print 'at end of file processing of ',i_final_histo_name_,bdt_value,bdt_value2,h_jet1_theta.Integral()
...
def process_files():
    ...
    files_weights2_polm80_VLC7_='/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/MVATrainingTrees_Jan2020_E_theta_BTag_tight_Mass_Cuts/dataset/filesPolm80GiniIndexNormNumEventsMaxDepth3NTrees300AdaBoostBeta020NCuts_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins___hhqq_vs_hzqq__ee_qq__ee_qqqq/dataset/weights/TMVAClassification_BDT.weights.xml'
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC7_,files_weights2_polm80_VLC7_,isSignalData_)
    ...
    files_weights2_polp80_VLC7_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/MVATrainingTrees_Jan2020_E_theta_BTag_tight_Mass_Cuts/dataset/filesPolp80GiniIndexNormNumEventsMaxDepth3NTrees300AdaBoostBeta020NCuts_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins___hhqq_vs_hzqq__ee_qq__ee_qqqq/dataset/weights/TMVAClassification_BDT.weights.xml"                             
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC7_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC7_,files_weights2_polp80_VLC7_,isSignalData_)
    ...
    files_weights2_polm80_VLC11_='/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/MVATrainingTrees_Jan2020_E_theta_BTag_tight_Mass_Cuts/dataset/filesPolm80GiniIndexNormNumEventsMaxDepth3NTrees300AdaBoostBeta020NCuts_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins___hhqq_vs_hzqq__ee_qq__ee_qqqq/dataset/weights/TMVAClassification_BDT.weights.xml'
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    #process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC11_,files_weights2_polm80_VLC11_,isSignalData_)
    ...
    files_weights2_polp80_VLC11_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/MVATrainingTrees_Jan2020_E_theta_BTag_tight_Mass_Cuts/dataset/filesPolp80GiniIndexNormNumEventsMaxDepth3NTrees300AdaBoostBeta020NCuts_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins___hhqq_vs_hzqq__ee_qq__ee_qqqq/dataset/weights/TMVAClassification_BDT.weights.xml"                             
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC11_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC11_,files_weights2_polp80_VLC11_,isSignalData_)
    ...
    files_weights2_polm80_VLC14_='/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/MVATrainingTrees_Jan2020_E_theta_BTag_tight_Mass_Cuts/dataset/filesPolm80GiniIndexNormNumEventsMaxDepth3NTrees300AdaBoostBeta020NCuts_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins___hhqq_vs_hzqq__ee_qq__ee_qqqq/dataset/weights/TMVAClassification_BDT.weights.xml'
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polm80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polm80_VLC14_,files_weights2_polm80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hhz__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins_AllEvents.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__hzqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
    ...
    final_histo_name_="/eos/user/w/weberma2/HistoFiles/HHZAnalyzer/190904Prod/VLC14_NJets6_finalAnalysis/polp80/NTuplesAnalysis_E_theta_BTag_tight_Mass_Cuts/MVATrainingReader_BDT__ee_qqqqqq__vs__hzqq__ee_qq__ee_qqqq__HHZ__ee_qqqqqq__histofiles_BDT_GiniIndexNormNumEventsMaxDepth3AdaBoostBeta020Trees300NCuts20_noEratios_noCosThetaHel_noCTagSum_noj3dalphaCTagCTagMax_noLTagMins.root"
    process_event(final_histo_name_,input_file_,files_weights_polp80_VLC14_,files_weights2_polp80_VLC14_,isSignalData_)
